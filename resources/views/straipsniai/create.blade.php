                    ...
                    <div class="mt-6">
                        <form action="{{ route("straipsnis.store") }}" method="POST" class="w-full space-y-6">
                            ...
                            <div class="w-full">
                                ...
                                <div class=" relative ">
                                    <textarea name="tekstas" required class="h-96 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"></textarea>
                                </div>
                            </div>
                            <div>
