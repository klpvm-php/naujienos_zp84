                                ...
                                <div class="w-full lg:w-3/4 px-2 min-h-screen">
                                    <div class="w-full h-full">
                                        ...
                                        <div class=" relative h-full">
                                            <textarea name="tekstas" class="ckeditor h-full rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">{{ $straipsnis->tekstas }}</textarea>
                                        </div>
                                    </div>
                                </div>
