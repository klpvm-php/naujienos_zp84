<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow sm:max-w-xl sm:w-full sm:mx-auto sm:overflow-hidden">
                <div class="px-4 py-8 sm:px-10">
                    ...
                    <div class="mt-6">
                        <form action="{{ route("straipsnis.update", $straipsnis->id) }}" method="POST" class="w-full space-y-6">
                            @csrf
                            @method("PUT")
                            <div class="w-full">
                            ...
                            <div class="w-full">
                                ...
                                <div class=" relative ">
                                    <textarea name="tekstas" required class="h-96 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">{{ $straipsnis->aprasymas }}</textarea>
                                </div>
                            </div>
                            <div>
