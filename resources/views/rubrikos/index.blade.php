                        ...
                        <table class="min-w-full leading-normal">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <a href="{{ route("rubrika.edit", $rubrika->id) }}" class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        ...
                                        <form action="{{ route("rubrika.destroy", $rubrika->id) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method("DELETE")
